...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-blue-50 py-12 px-4 sm:px-6 lg:px-8 bg-gradient-linear">
      <h1 className="text-orange-600 text-[4rem] absolute top-0 brand sm:text-[5rem]">DigiDukaan</h1>
